...
Use the option to disable cache in your browser to prevent problems where your page doesn't update with code changes. If you don't do this, your page may not reload your javascript files when you refresh the page.
